function TsfEditorProxy(editorId, layoutConverter, tsfEditorEventsSink)
{
	...
	{
        layoutConverter.toScreenCoordinates(compositionLayout, windowLayout, function(rect)
        {
            m_eventsSink.onCompositionLayoutChange(rect);
        });
	}
