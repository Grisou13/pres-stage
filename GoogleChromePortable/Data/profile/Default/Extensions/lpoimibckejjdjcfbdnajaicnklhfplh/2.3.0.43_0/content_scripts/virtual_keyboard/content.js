...
var tsfEditors = new KasperskyLabVirtualKeyboard.TsfEditorsManager();
...
function isFocusInProtectableElement()
{
...
{
	if (isFocusInProtectableElement())
	{
...
function tsfEditorCreate(editorId)
{
	if (isFocusInProtectableElement())
	{
		tsfEditors.insert(editorId, createTsfEditor(document.activeElement, editorId));
	}
}
...
function AddOnRequestListener()
{
	...
	function(request, sender, sendResponse) 
	{
		try
		{
			...
			{
				tsfEditorCreate(request.editorId);
			}
